...
```{r}
rf <- randomForest(Type2 ~ Catch_rate + Height_m + Weight_kgs + HP + Attack + Defense + Sp.Atk+ Sp.Def + Speed + Gen, importance = TRUE, mtry=1, data = trainingData, na.action=na.exclude)
...
Our random forest correctly guesses the Type2 for about 24% of the Pokemon. It seems like we can't consistently predict a Pokemon's Type2 based on its stats.
